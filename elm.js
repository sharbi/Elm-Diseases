...
Elm.Circles.make = function (_elm) {
   ...
   var addLines = F2(function (loc1,
   loc2) {
      return function () {
         var y = 500 - $Basics.toFloat($Basics.snd(loc2));
         var x = $Basics.toFloat($Basics.fst(loc2)) - 475;
         var b = 500 - $Basics.toFloat($Basics.snd(loc1));
         var a = $Basics.toFloat($Basics.fst(loc1)) - 475;
      ...
      return function () {
         ...
         {case "Create":
            return function () {
                 ...
                 {case "disease":
                    return m.editDisease ? _U.replace([["dId"
                      ...
                      m) : m;
                    case "symptom":
                    return m.editSymptoms ? function () {
                         var loc1 = function (id) {
                            return A2($List.map,
                            $Basics.snd,
                            A2($List.filter,
                            function (_v10) {
                               return function () {
                                  switch (_v10.ctor)
                                  {case "_Tuple2":
                                     return _U.eq(_v10._0,id);}
                                  _U.badCase($moduleName,
                                  "on line 85, column 73 to 88");
                               }();
                            },
                            m.diseaseLocations));
                         };
                         return _U.replace([["sId"
                                            ,m.sId + 1]
                                           ,["name",""]
                                           ,["symptoms"
                                            ,A2($List._op["::"],
            ...
            return function () {
                 ...
                 {case "disease":
                    return function () {
                         var updateDisease = function (_v24) {
                            return function () {
                               switch (_v24.ctor)
                               {case "_Tuple2":
                    ...
                    case "symptom":
                    return function () {
                         var updateSymptom = function (_v28) {
                            return function () {
                               switch (_v28.ctor)
                               {case "_Tuple2":
